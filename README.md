...
This is a demo for users to use the simplified MCS upload functions. For the complete [documentations](#documentation).
...
Then you can use `dotenv` package to load the `.env` as environment variables.
```python
import os
