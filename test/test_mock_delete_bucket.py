...
def test_delete_bucket_success(mock_requests, shared_mock_bucket, shared_bucket_list):
...
def test_delete_bucket_not_found(mock_requests, shared_mock_bucket, shared_bucket_list):
...
def test_delete_bucket_failure(mock_requests, shared_mock_bucket, shared_bucket_list):
    bucket_name = "test-bucket"
